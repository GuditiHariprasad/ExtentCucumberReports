...
public class LoginTest1 extends BaseTest {
    ...
    LoginPage loginPage;
    @Test(description = "Login",priority =2,groups = "group1")
    public void loginTest1() {
        loginPage=new LoginPage(driver);
        loginPage.login("admin","admin123");
        System.out.println("Logged in");
    }
    @Test(dataProvider = "dp",description = "login1",priority=1,enabled = false,groups ="group1")
    ...
    @Test(dataProvider = "dp",dataProviderClass = LoginDataProvider.class,description = "login2",priority=0,dependsOnMethods ={"loginTest1"},dependsOnGroups = {"group1"})
